...
export default function SuccessfulSignUp() {
  return (
    <>
      <div className="fixed top-0 z-50 w-[100%] bg-[white] h-[783px] p-4 box-border">
        <div className="flex flex-col justify-center items-center h-[calc(100vh-50px)] xl:h-[783px]">
          <SignupImg />
