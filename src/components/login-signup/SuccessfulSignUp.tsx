...
export default function SuccessfulSignUp() {
  return (
    <>
      <div className="bg-slate-300 h-[783px]">
        <div className="flex flex-col justify-center  items-center h-screen xl:h-[783px]">
          ...
          <p className="text-sm text-[#4C4F52]">우를가 제공하는 다양한 서비스를 즐겨보세요!</p>
        </div>

        <div className="flex justify-center pb-7 px-5">
          <Link href={"/login"} className="w-full">
            <button className="bg-primarynormal text-white h-[47px] w-full rounded-xl font-medium">시작하기</button>
          </Link>
        </div>
      </div>
    </>
