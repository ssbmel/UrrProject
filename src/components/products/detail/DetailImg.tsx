    ...
    <div className="relative">
      ...
      {showMore && !isExpanded && (
        <button
          ...
          className="absolute border-[1px] border-[#EAECEC)] bottom-[calc(100%-480px)] left-1/2 transform -translate-x-1/2 w-[343px] h-[52px] bg-white text-[#1A82FF] rounded mt-4 cursor-pointer text-[14px] flex justify-center items-center xl:hidden"
        >
          상품정보 더보기
